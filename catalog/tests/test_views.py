...
from catalog.models import BookInstance, Book, Genre, Lang
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_language = Lang.objects.create(name='English')
        ...
        test_book.genre.set((test_genre,)) # Direct assignment of many-to-many types not allowed.
        test_book.save()
